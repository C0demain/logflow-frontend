    ...
    return (
      <div className="my-2 space-y-3 bg-white shadow-lg rounded-md p-6">
        <div className="flex items-center space-x-6">
          <div>
            <h1 className="text-2xl">{orderService?.title}</h1>
          </div>
          <div className="flex">
            <h1 className="text-2xl mr-3">Preço:</h1>
            <h1 className="text-2xl">R${orderService?.value}</h1>
          </div>
          <div className="flex">
            <h1 className="text-2xl mr-3">Descrição:</h1>
            <p className="text-2xl">{orderService?.description}</p>
          </div>
        </div>
      </div>
    );
